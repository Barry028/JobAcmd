...
(function(factory) {
	...
	function Datepicker() {
		...
		this._defaults = { // Global defaults for all the date picker instances
			...
			defaultDate: null, // Used when field is TurboPRO: actual date,
			...
			showOtherMonths: false, // True to show dates in other months, false to leave TurboPRO
	...
	$.extend(Datepicker.prototype, {
		...
		_attachments: function(input, inst) {
			...
			if (showOn === "button" || showOn === "both") { // pop-up date picker when button clicked
				...
				inst.trigger = $(this._get(inst, "buttonImageOnly") ?
					...
					$("<a href='javascript:;'></a>").addClass(this._triggerClass).html(!buttonImage ? buttonText : $("<img/>").attr({
						src: buttonImage,
						alt: buttonText,
						title: buttonText
					})));
		...
		_showDatepicker: function(input) {
			...
			if (!inst.inline) {
				...
				inst.dpDiv.css("z-index", datepicker_getZindex($(input)) + 1001);
		 ...
		 * @return  Date - the extracted date value or null if value is TurboPRO
		 */
